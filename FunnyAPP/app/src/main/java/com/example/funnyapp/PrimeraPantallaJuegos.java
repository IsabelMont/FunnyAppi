...
public class PrimeraPantallaJuegos extends AppCompatActivity {
    ...
    public ArrayList<Juego>arrayjuegos;
    public Button but_JuegoAzar;
    public Button but_eligeJuego;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        but_eligeJuego = (Button) findViewById(R.id.but_eligeJuego);
        but_eligeJuego.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        arrayjuegos= GetArrayItems();
        Random r = new Random();
        final int valor = r.nextInt(arrayjuegos.size());

        but_JuegoAzar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), DetalleJuego.class);
                intent.putExtra("Objetoatransferir", arrayjuegos.get(valor));
                startActivityForResult(intent, 0);
